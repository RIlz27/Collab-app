        ...
        <div class="relative z-10 max-w-6xl px-4 py-32 mx-auto text-white text-left">
            ...
            <div class="mt-8 bg-white p-4 rounded-xl inline-block">
                ...
                <div class="flex gap-2">
                    <button class="bg-orange-400 text-white px-4 py-2 rounded-full font-semibold">Properti Hunian</button>
                    <button class="bg-gray-200 text-gray-700 px-4 py-2 rounded-full font-semibold">Properti Komersial</button>
